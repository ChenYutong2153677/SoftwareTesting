<template>
  <div class="computer">
    <div class="top">
      <div style="width: 30%;">
        <h1>电脑销售系统</h1>
        <el-upload class="upload-demo" action="http://localhost:5000/computer" :on-preview="handlePreview"
    ...
    <div class="result">
      <el-table 
        ...
        <el-table-column prop=zj label="主机">
        </el-table-column>
        <el-table-column prop=xsq label="显示器">
        </el-table-column>
        <el-table-column prop=ws label="外设">
        </el-table-column>
